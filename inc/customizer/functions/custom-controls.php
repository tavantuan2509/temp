...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class test_Customize_Header_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
	 ...
	 */
	class test_Customize_Description_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
		public function render_content() {
	 ...
	 */
	class test_Customize_Category_Dropdown_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
		public function render_content() {
			...
			if ( ! empty( $categories ) ) : ?>
					...
					<label>
						...
						<select <?php $this->link(); ?>>
							<option value="0"><?php esc_html_e( 'All Categories', 'test' ); ?></option>
						<?php
	 ...
	 */
	class test_Customize_Upgrade_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
		public function render_content() {
			...
			<div class="upgrade-pro-version">
				...
				<span class="customize-control-title"><?php esc_html_e( 'Pro Version', 'test' ); ?></span>
				...
				<p>
					<a href="<?php echo esc_url( __( 'https://themezee.com/addons/test-pro/', 'test' ) ); ?>?utm_source=customizer&utm_medium=button&utm_campaign=test&utm_content=pro-version" target="_blank" class="button button-secondary">
			...
			<div class="upgrade-plugins">
				...
				<span class="customize-control-title"><?php esc_html_e( 'ThemeZee Plugins', 'test' ); ?></span>
				...
				<p>
					<a href="<?php echo esc_url( __( 'https://themezee.com/plugins/', 'test' ) ); ?>?utm_source=customizer&utm_medium=button&utm_campaign=test&utm_content=plugins" target="_blank" class="button button-secondary">
